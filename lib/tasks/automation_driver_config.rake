...
task :add_initial_adc => :environment do
  ...
  unless p.nil?
    bvt_source_paths = [
      {"local" => "C:\\QA Automation\\Camps\\trunk\\framework\\package", "remote" => "https://fndsvn.dev.istuary.com/foundation/QA Automation/Camps/trunk/framework/package"},
      {"local" => "C:\\QA Automation\\Camps\\trunk\\framework\\datapools", "remote" => "https://fndsvn.dev.istuary.com/foundation/QA Automation/Camps/trunk/framework/datapools"},
      {"local" => "C:\\QA Automation\\Camps\\trunk\\framework\\testsuites_testplus\\BVTs", "remote" => "https://fndsvn.dev.istuary.com/foundation/QA Automation/Camps/trunk/framework/testsuites_testplus/BVTs"}
    ]
    ...
    reg_source_paths = [
      {"local" => "C:\\QA Automation\\Camps\\trunk\\framework\\package", "remote" => "https://fndsvn.dev.istuary.com/foundation/QA Automation/Camps/trunk/framework/package"},
      {"local" => "C:\\QA Automation\\Camps\\trunk\\framework\\datapools", "remote" => "https://fndsvn.dev.istuary.com/foundation/QA Automation/Camps/trunk/framework/datapools"},
      {"local" => "C:\\QA Automation\\Camps\\trunk\\framework\\testsuites_testplus\\regressions", "remote" => "https://fndsvn.dev.istuary.com/foundation/QA Automation/Camps/trunk/framework/regressions"}
    ]
  ...
  unless p.nil?
    bvt_source_paths = [
      {"local" => "C:\\QA Automation\\Endurance\\trunk\\framework\\package", "remote" => "https://fndsvn.dev.istuary.com/foundation/QA Automation/Endurance/trunk/framework/package"},
      {"local" => "C:\\QA Automation\\Endurance\\trunk\\framework\\datapools", "remote" => "https://fndsvn.dev.istuary.com/foundation/QA Automation/Endurance/trunk/framework/datapools"},
      {"local" => "C:\\QA Automation\\Endurance\\trunk\\framework\\testsuites\\Dashboard BVTs", "remote" => "https://fndsvn.dev.istuary.com/foundation/QA Automation/Endurance/trunk/framework/testsuites/Dashboard BVTs"}
    ]
    ...
    reg_source_paths = [
      {"local" => "C:\\QA Automation\\Endurance\\trunk\\framework\\package", "remote" => "https://fndsvn.dev.istuary.com/foundation/QA Automation/Endurance/trunk/framework/package"},
      {"local" => "C:\\QA Automation\\Endurance\\trunk\\framework\\datapools", "remote" => "https://fndsvn.dev.istuary.com/foundation/QA Automation/Endurance/trunk/framework/datapools"},
      {"local" => "C:\\QA Automation\\Endurance\\trunk\\framework\\testsuites\\regressions", "remote" => "https://fndsvn.dev.istuary.com/foundation/QA Automation/Endurance/trunk/framework/testsuites/regressions"}
    ]
  ...
  unless p.nil?
    bvt_source_paths = [
      {"local" => "C:\\QA Automation\\Sports\\trunk\\framework\\package", "remote" => "https://fndsvn.dev.istuary.com/foundation/QA Automation/Sports/trunk/framework/package"},
      {"local" => "C:\\QA Automation\\Sports\\trunk\\framework\\datapools", "remote" => "https://fndsvn.dev.istuary.com/foundation/QA Automation/Sports/trunk/framework/datapools"},
      {"local" => "C:\\QA Automation\\Sports\\trunk\\framework\\testsuites\\BVTs", "remote" => "https://fndsvn.dev.istuary.com/foundation/QA Automation/Sports/trunk/framework/testsuites/BVTs"}
    ]
    ...
    reg_source_paths = [
      {"local" => "C:\\QA Automation\\Sports\\trunk\\framework\\package", "remote" => "https://fndsvn.dev.istuary.com/foundation/QA Automation/Sports/trunk/framework/package"},
      {"local" => "C:\\QA Automation\\Sports\\trunk\\framework\\datapools", "remote" => "https://fndsvn.dev.istuary.com/foundation/QA Automation/Sports/trunk/framework/datapools"},
      {"local" => "C:\\QA Automation\\Sports\\trunk\\framework\\testsuites\\regressions", "remote" => "https://fndsvn.dev.istuary.com/foundation/QA Automation/Sports/trunk/framework/testsuites/regressions"}
    ]
  ...
  unless p.nil?
    ...
    reg_source_paths = [
      {"local" => "C:\\QA Automation\\Endurance\\trunk\\framework\\package", "remote" => "https://fndsvn.dev.istuary.com/foundation/QA Automation/Endurance/trunk/framework/package"},
      {"local" => "C:\\QA Automation\\Endurance\\trunk\\framework\\datapools", "remote" => "https://fndsvn.dev.istuary.com/foundation/QA Automation/Endurance/trunk/framework/datapools"},
      {"local" => "C:\\QA Automation\\Endurance\\trunk\\framework\\testsuites\\regressions\\FUI", "remote" => "https://fndsvn.dev.istuary.com/foundation/QA Automation/Endurance/trunk/framework/testsuites/regressions/FUI"}
    ]
  ...
  unless p.nil?
    bvt_source_paths = [
      {"local" => "C:\\QA Automation\\Backoffice\\trunk\\framework\\package", "remote" => "https://fndsvn.dev.istuary.com/foundation/QA Automation/Backoffice/trunk/framework/package"},
      {"local" => "C:\\QA Automation\\Backoffice\\trunk\\framework\\datapools", "remote" => "https://fndsvn.dev.istuary.com/foundation/QA Automation/Backoffice/trunk/framework/datapools"},
      {"local" => "C:\\QA Automation\\Backoffice\\trunk\\framework\\testsuites\\Dashboard BVTs", "remote" => "https://fndsvn.dev.istuary.com/foundation/QA Automation/Backoffice/trunk/framework/testsuites/Dashboard BVTs"}
    ]
    ...
    reg_source_paths = [
      {"local" => "C:\\QA Automation\\Backoffice\\trunk\\framework\\package", "remote" => "https://fndsvn.dev.istuary.com/foundation/QA Automation/Backoffice/trunk/framework/package"},
      {"local" => "C:\\QA Automation\\Backoffice\\trunk\\framework\\datapools", "remote" => "https://fndsvn.dev.istuary.com/foundation/QA Automation/Backoffice/trunk/framework/datapools"},
      {"local" => "C:\\QA Automation\\Backoffice\\trunk\\framework\\testsuites\\regressions", "remote" => "https://fndsvn.dev.istuary.com/foundation/QA Automation/Backoffice/trunk/framework/testsuites/regressions"}
    ]
  ...
  unless p.nil?
    bvt_source_paths = [
      {"local" => "C:\\QA Automation\\Membership\\trunk\\framework\\package", "remote" => "https://fndsvn.dev.istuary.com/foundation/QA Automation/Membership/trunk/framework/package"},
      {"local" => "C:\\QA Automation\\Membership\\trunk\\framework\\common", "remote" => "https://fndsvn.dev.istuary.com/foundation/QA Automation/Membership/trunk/framework/common"},
      {"local" => "C:\\QA Automation\\Membership\\trunk\\framework\\components", "remote" => "https://fndsvn.dev.istuary.com/foundation/QA Automation/Membership/trunk/framework/components"},
      {"local" => "C:\\QA Automation\\Membership\\trunk\\framework\\objects", "remote" => "https://fndsvn.dev.istuary.com/foundation/QA Automation/Membership/trunk/framework/objects"},
      {"local" => "C:\\QA Automation\\Membership\\trunk\\framework\\testsuites", "remote" => "https://fndsvn.dev.istuary.com/foundation/QA Automation/Membership/trunk/framework/testsuites"}
    ]
  ...
  unless p.nil?
    bvt_source_paths = [
      {"local" => "C:\\QA Automation\\testplus-auto\\common", "remote" => "git://git.dev.istuary.com/aw-automation/testplus-auto.git"},
      {"local" => "C:\\QA Automation\\testplus-auto\\testsuites", "remote" => "git://git.dev.istuary.com/aw-automation/testplus-auto.git"}
    ]
